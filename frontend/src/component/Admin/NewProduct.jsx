...
function NewProduct() {
 ...
 const categories = [
  ...
  const createProductSubmitHandler = (e) => {
    e.preventDefault();
    try {
      // Send JSON including images as base64 data URLs
      const payload = {
        name,
        price,
        description,
        ...
        info,
        discountPercentage,
        images: imagesPreview, // array of full data URLs like "data:image/png;base64,...."
      };
      console.log("Submitting product (JSON) imagesPreview count:", imagesPreview.length);
     ...
     files.forEach((file) => {
       ...
       reader.onload = () => {
         if (reader.readyState === 2) {
           ...
           // keep full dataUrl for preview and upload (as base64 data URL)
